...
#define DGB_assert(expression,arg) ((expression) ? (void)0 :\
(\
...
#define DGB_debug_write(arg) ((DBG_set(DBG_CURRENT_CONTROLLER,__FILE__,__LINE__)),(DGB_debug_write_func arg))
